<template>
  ...
  <div class="flex flex-row items-center p-2 mb-12 md:mb-24 rounded-full bg-neutral glass opacity-75 border-0 hover:bg-neutral hover:opacity-60 transition-all">
    ...
    <!-- <span class="w-1 h-8 bg-white animate-pulse ml-0"></span> -->
  </div>
  <span ref="util" class="opacity-0 text-3xl font-bold whitespace-pre fixed top-0 left-0 -z-50"></span>
</template>
